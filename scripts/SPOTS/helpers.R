...
readSpots = function(loc, nreplicates = 1){
  ...
  coords1[which((coords$imagerow > 250) & (coords1$imagecol > 500)),1:2] = c(235.7749, 379.6919 + (379.6919-373.2788))
  ...
  if(nreplicates == 1){
    ...
    return(list("RNA1" = RNA1, "RNA2"=RNA2, "protein1" = prot1, "protein2" = protein2, 
                "AAR1" = aar1, "AAR2" = aar2, "coords1" = coords, "coords2" = coords2))
  }
}
...
SpotsProteinData = function(loc, genepairs){
  ...
  df = rbind(df_1, df_2) %>% mutate(idx = 1:nrow(.))
