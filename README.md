...
## Usage
In `./tutorial` there is a [`RMD` script](https://htmlpreview.github.io/?https://github.com/nygctech/INLAomics/blob/main/tutorial/tutorial.html) which gives some details of the implemented INLA methods and required format of the data. 
